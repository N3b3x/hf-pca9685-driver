...
function initSearch() {
  ...
  request.open('GET', '/hf-pca9685-driver/development/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/hf-pca9685-driver/development/assets/css/just-the-docs-' + theme + '.css');
}
